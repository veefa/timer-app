...
const Timer: React.FC = () => {
    ...
    // Starting and Stoping the timer then Cleaning up the interval
    useEffect(() => {
    ...
    return (
        <div className="flex flex-col justify-center items-center space-y-4">
            <h1 className="py-8 font-bold text-gray-600 text-5xl trex">{formatTime(timeLeft)}</h1>
            <div className="space-x-4">
                <button onClick={() => setIsRunning(!isRunning)}
                    className="bg-blue-400 px-6 py-3 rounded-lg text-gray-50">
                ...
                <button onClick={() => {
                    ...
                    className="bg-red-700 px-5 py-3 rounded-lg text-white"
                >
                    Reset
                </button>
            </div>
